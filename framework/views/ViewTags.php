...
class ViewTags {
    ...
    public static
    function iniciarBloco($bloco) {
        $GLOBALS[$bloco] = "";
        ob_start();
    }

    public static
    function terminarBloco($bloco) {
        $GLOBALS[$bloco] = ob_get_clean();
    }

    public static
    function actionLink($rota) {
        echo($rota);
    }

    public static
    function tabela($tipo, $registrosDoTipo, $opcoes = null) {
    ...
    public static
    function iniciarFormulario($controller, $action) {
